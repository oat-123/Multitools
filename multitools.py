...
# โค้ดเวอร์ชันปรับปรุงแล้ว สำหรับฟีเจอร์ "จัดยอดพิธี"
    ...
    if "เลือกทั้งหมด" in ตัวกรอง_หน้าที่_เลือก or set(ตัวกรอง_หน้าที่_เลือก) >= set(ตัวเลือก_หน้าที่):
    ...
    if "เลือกทั้งหมด" in excluded_clubs or set(excluded_clubs) >= set(ตัวเลือก_ชมรม):
        filtered_clubs = ตัวเลือก_ชมรม
        st.info("✅ เลือกไม่เอาทุกชมรมแล้ว")
    else:
        filtered_clubs = excluded_clubs
