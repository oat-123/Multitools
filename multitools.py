...
if mode == "night_duty":
    ...
    if ยอด_file:
        ...
        st.success("✅ อัปเดต 'สถิติโดนยอด' สำเร็จแล้ว!")
        st.markdown("👉 [คลิกที่นี่เพื่อดู Google Sheets](https://docs.google.com/spreadsheets/d/e/2PACX-1vSf6OB3YE98NPUBjuN7c7tdp93kmj0kEAQMvMiu4FECY4OgbQgQ-AWwz31TcabtrlzWPgcilDmsG4uZ/pubhtml)")
