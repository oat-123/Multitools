...
if mode == "night_duty":
    ...
    try:
        ...
        st.components.v1.iframe(
            src="https://docs.google.com/spreadsheets/d/1PjT38W2Zx7KV764yv9Vjwo9i0TJPacRI0iUGzP0ItAU/pubhtml?gid=0&single=true&range=A1:I100&widget=false&headers=false",
            height=700,
            width=1000)
