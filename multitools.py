...
if mode == "night_duty":
    ...
    if ยอด_file:
        ...
        # 5. ตรวจสอบหรือเพิ่มคอลัมน์ "สถิติโดนยอด"
        ...
        # 6. อัปเดตแต้มเฉพาะคนที่มีในไฟล์ยอด
        ...
        st.success("✅ อัปเดต 'สถิติโดนยอด' สำเร็จโดยไม่เปลี่ยนคอลัมน์อื่น")
